...
public:
    ...
    virtual bool createTaskSet(uint32_t group, ITASKSETFUNC pFunc, void* pArg, uint32_t uTaskCount, ITASKSETHANDLE* pDepends,
                               uint32_t nDepends, const char* setName, ITASKSETHANDLE* pOutHandle) = 0;
