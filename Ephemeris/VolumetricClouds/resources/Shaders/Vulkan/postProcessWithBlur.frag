...
vec4 HLSLmain(PSIn input0)
{
  ...
  vec4 blurCloudsResult = texture(sampler2D(g_BlurTexture, g_LinearClampSampler), input0.TexCoord);
  volumetricCloudsResult = mix(blurCloudsResult * 0.8, volumetricCloudsResult, volumetricCloudsResult.a);
