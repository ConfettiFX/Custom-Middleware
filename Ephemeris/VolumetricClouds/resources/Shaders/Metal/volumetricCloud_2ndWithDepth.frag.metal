...
struct Fragment_Shader
{
    ...
    float4 main(PSIn input)
    {
        ...
        float density = GetDensity_Double_Layers_WithComparingDepth(CameraPosition.xyz, worldPos.xyz, viewDir, randomSeed, intensity, atmosphereBlendFactor, depth, db_uvs);
