...
{
    CumulusCloudParams(): scaleMultiplier(1.0f), cloudCountX(10), cloudCountZ(10), baseHeight(10000.0f) {}
    float scaleMultiplier;
    float baseHeight;
    uint  cloudCountZ;
    uint  cloudCountX;
...
void generateClouds(ICloudsManager& CloudsManager, const CumulusCloudParams& cClParams, const DistantCloudParams& dClParams,
                    uint seed = 81936);
