...
LocalTime::LocalTime(bool bNow /*=false*/):
    m_localSeconds(0), m_GMTOffset(0), m_localYear(2000), m_localMonth(1), m_localDay(1), m_localHours(0), m_localMinutes(0),
    // 	m_localHours(6),
    // 	m_localMinutes(35),
...
double LocalTime::getJ200Centuries(bool bAtomic) const
{
    ...
    res = (1720996.5 + 1.0)
          //	Consider leap years
          - floor(year / 100.0) + floor(year / 400.0) + floor(year * 365.25) + floor(30.6001 * (month + 1));
